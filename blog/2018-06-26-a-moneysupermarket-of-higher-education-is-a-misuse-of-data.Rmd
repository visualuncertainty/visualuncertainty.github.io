...
date: 2018-06-26
title: 'A Moneysupermarket of Higher Education?'
tags: ["Data Science"]
...
The idea of taking a few easily available metrics about graduate achievements and using them to help students choose their path is destined to be bad and dangerous use of data. Why do graduates of a university earn more or less? There are lots of reasons, some related to the course, but many for lots of bad reasons. A graduate could earn more because:
...
Data driven decision making is a fallacy and a folly. Data should only ever be used to advice a decision making process not make the decision for us. I hope the bidders will create a site which illustrates that there are few experiences in life that can be reduced to a comparison table.
